...
const Header = ({isDarkMode,setIsDarkMode}) => {
  ...
  Hadifa Rousheen
        ...
        setIsDarkMode(!isDarkMode)
          }}><img className="h-6 w-6 md:h-8 md:w-8 mt-1 mr-2" src={isDarkMode?"https://cdn-icons-png.flaticon.com/128/869/869869.png":"https://cdn-icons-png.flaticon.com/128/702/702471.png"}/></span>
          <Link
            to="skillsSection"
            smooth={true}
            duration={500}
