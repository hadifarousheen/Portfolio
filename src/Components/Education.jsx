const Education=()=>{
    return (
        <div className="h-screen ">
            <h1 className="text-center p-4 text-4xl font-bold [text-shadow:4px_6px_10px_rgba(145,44,240,1)] text-white">Education</h1>
<ul className="timeline timeline-vertical ">
  <li>
    <div className="timeline-start timeline-box">
        <div className="p-2 border border-gray-800 shadow-xl/30 shadow-white">
            <h1 className="text-3xl">Bachelero's of Technology (2021-2025)</h1>
            <h2 className="text-2xl">Jyothishmathi Institute of Technology and Science</h2>
  ...
  <li>
    ...
    <div className="timeline-end timeline-box"><div className="p-2 border-gray-800 shadow-xl/30 shadow-white">
  ...
  <li>
    <hr className="bg-purple-600" />
    <div className="timeline-start timeline-box"><div className="p-2 border-gray-800 shadow-xl/30 shadow-white ">
